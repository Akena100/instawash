...
import 'package:instawash/core/extensions/extensions.dart';

import 'package:instawash/models/product.dart';
...
Widget pricesContainer(Service packageModel) {
  return Container(
    ...
    child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      priceRow("Package Total", "${packageModel.name}.000 KWD"),
      priceRow("Add ons", "0.000 KWD"),
      priceRow("Promo Discount", "0.000 KWD"),
      priceRow("Grand total", "${packageModel.id}.000 KWD"),
    ]),
  );
}
